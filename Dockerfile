...
ARG GOOGLE_ID_ARG
ARG GOOGLE_SECRET_ARG
ARG NEXT_PUBLIC_BASE_URL_ARG
...
ENV GOOGLE_ID=$GOOGLE_ID_ARG
ENV GOOGLE_SECRET=$GOOGLE_SECRET_ARG
ENV NEXT_PUBLIC_BASE_URL=$NEXT_PUBLIC_BASE_URL_ARG
